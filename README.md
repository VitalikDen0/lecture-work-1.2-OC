...
На данный момент завершено **Задание 1**:
...
\`\`\`
lecture-work-1.2-OC/
├─ assignment1/                # Главное задание - BASH скрипт
│   └─ README.md               # Документация assignment1
│   └─ system-utility.sh       # Основной BASH скрипт
│   └─ .gitkeep               # Признак директории
├─ assignment2/                # Второе задание (основа)
│   └─ .gitkeep               # Признак директории
├─ .gitignore                 # Шаблоны для git
└─ README.md                # Этот файл
\`\`\`

## Примечания

- Каждое задание содержит собственное ректорию
- Основные скрипты находятся в ассайнментах
- Документация доступна в каждой папке


## Основное описание

Настоящий репозиторий содержит практические задания для курса Операционных систем. Проект структурирован так, чтобы включать BASH-скрипты и программы на Языке C, демонстрирующие различные концепции системного программирования.

## Основные задания

### Задание 1: BASH-Консольная Отилита

Более одного, это демонстрация работы с аргументами командного редактора и выводом системной информации.---
